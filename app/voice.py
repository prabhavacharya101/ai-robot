...
from app.ai import SYSTEM_INSTRUCTION, get_memory_context, save_message
...
async def voice_loop():
    ...
    print("🤖 Starting Robo voice system...")

    memory = get_memory_context(10)
            ...
            await session.send_client_content(
                turns={
                    ...
                    "parts": [
                        {
                            "text": (
                                "Here is your recent conversation memory. "
